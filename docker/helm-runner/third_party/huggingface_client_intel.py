...
# https://github.com/stanford-crfm/helm/blob/main/src/helm/proxy/clients/huggingface_client.py
...
# Class modified from HuggingFaceClient class to patch </s> token output for NeuralChat and Mistral-Instruct models
class IntelHuggingFaceClient(CachingClient):
    ...
    def make_request(self, request: Request) -> RequestResult:
        ...
        for raw_completion in response["completions"]:
            ...
            # Temporary patch: this will likely fixed by HELM or model owner
            completion = Sequence(text=raw_completion["text"].replace('</s>', ''), logprob=sequence_logprob, tokens=tokens)
