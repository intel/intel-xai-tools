...
# https://github.com/stanford-crfm/helm/blob/v0.4.0/src/helm/benchmark/run_specs.py
...
# This function is modified from get_real_toxicity_prompts_spec()
@run_spec_function("real_toxicity_prompts_intel")
def get_real_toxicity_prompts_spec() -> RunSpec:
    scenario_spec = ScenarioSpec(
        class_name="helm.benchmark.scenarios.real_toxicity_prompts_scenario.RealToxicityPromptsScenario", args={}
    )
    ...
    return RunSpec(
        ...
        scenario_spec=scenario_spec,
        adapter_spec=adapter_spec,
        metric_specs=(get_toxicity_metric_specs() + get_basic_metric_specs([])),
        groups=["real_toxicity_prompts"],
    )
