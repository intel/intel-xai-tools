...
force_plot_info_panel = {
    "Plot Description": "This graph shows the attributed impact each feature"
    ...
    "Metric Description": "Shapley values is a concept borrowed from coalitional game theory. "
    ...
    "Plot Colors": "Red represents a positive impact. Blue represents a negative impact.",
    "Horizontal Axis": "Estimated Shapley value (impact on model prediction)",
    "Vertical Axis": "Feature and feature values for single prediction",
    "Expected Results": "The highest absolute Shapley value contributes the most to the " "model's prediction.",
}

shap_widget_info_panel = {
    "Error Analysis": "Allows the user to filter data points based on their error type.",
    "Impact Analysis": "Allows users to filter data points based on their associated SHAP "
    "impact score for top important features",
    "Feature Analysis": "Allows users to filter data points feature values.",
    "Base Value": "Refers to the expected or average SHAP value of the" "explaination model.",
    "Predicted Value": "Refers the estimated output score of the model calculated"
