...
from model_card_gen.base_model_card_field import BaseModelCardField
...
class ModelCard(BaseModelCardField):
    ...
    def to_json(self) -> Text:
        ...
        model_card_dict[
                validation.SCHEMA_VERSION_STRING] = validation.get_latest_schema_version()
