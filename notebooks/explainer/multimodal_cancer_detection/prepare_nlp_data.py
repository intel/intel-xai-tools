...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=os.path.join("annotation", "annotation.csv"),
    )
    ...
    prepare_data(
        os.path.join(root_folder, params.medical_reports_folder),
        os.path.join(root_folder, params.manual_annotations_file),
        os.path.join(root_folder, params.output_annotations_folder),
        os.path.join(root_folder, params.output_annotations_file),
    )
