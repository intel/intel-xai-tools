...
from data_utils import split_images
import json
...
def classify_images(image_folder, annotation_file):
    ...
    for filename in os.listdir(directory):
        ...
        if os.path.isfile(src):
            ...
            classification_type = manual_annotations[manual_annotations["Image_name"] == patient_id][
...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_folder", help="Location of image folder", default="PKG - CDD-CESM/CDD-CESM")
    parser.add_argument(
        "--segmentation_path", help="Location of segmentation path", default="Radiology_hand_drawn_segmentations_v2.csv"
    )

    params = parser.parse_args()

    root_folder = params.data_root

    # Preprocess data
    prepare_vision_data(
        os.path.join(root_folder, params.image_folder),
        os.path.join(root_folder, params.radiology_annotations_file),
        os.path.join(root_folder, params.segmentation_path),
    )
    ...
    split_images(infolder, data_dir)
